...
<form id="form1" name="form1" method="post" action="validarAgregarProducto.php" class="material">
    ...
    <div class="contenedor">
      ...
      <input type="text" name="tipoMaterial" placeholder="material" class="input50" required>
